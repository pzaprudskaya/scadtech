...
import { IAllHistoryEvents, IHistoryEvent } from '../../../shared/models/about-company-page.model';
...
export class HistoryComponent implements OnInit {
  ...
  ngOnInit() {
    this.historyEvents = [];
    this.historyEventsService.getHistoryEvents( 1000, 0 ).subscribe( ( historyEvents: IAllHistoryEvents ) => {
