...
export class EditDocumentationComponent implements OnInit {
  ...
  add() {
    const obj = {
      ...
      descriptionIssuedBy: (document.getElementById('descriptionIssuedBy') as HTMLInputElement).value,
      descriptionTypesOfJobs: (document.getElementById('descriptionTypesOfJobs') as HTMLInputElement).value,
      link: (document.getElementById('link') as HTMLInputElement).value,
      validity: (document.getElementById('validity') as HTMLInputElement).value,
    };
